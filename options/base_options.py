...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='test_lfgp_dresscode_unpaired_1110_v2',
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./dataset/Dresscode')
        ...
        self.parser.add_argument('--image_pairs_txt', type=str, default='test_pairs_unpaired_1008.txt')
